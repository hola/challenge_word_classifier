...
// F = 72.41617516783679877300 | BYTE = 31 | BIT = 34 | FS_S = 74256
// F = 72.42151818483503997400 | BYTE = 31 | BIT = 34 | FS_S = 74390
// F = 72.42685009158710008950 | BYTE = 33 | BIT = 34 | FS_S = 74384
// 31..37

int MULTIPLIER_BYTE = 33;
int MULTIPLIER_BIT 	= 34;
int MAX_DB_SIZE		= 74384 + 328;
int MAX_JS_SIZE		= 328;
int FILTER_SIZE		= 0;
