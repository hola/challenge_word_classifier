...
// no chance but just because it was done
...
module.exports = {
    ...
    test: function(word){
        ...
        return(check_buffer_tree_as_bitmap(buf_tree, word));
    }
}

String.prototype.char_code = function(pos) { let c = this.charCodeAt(pos)-96; return(c<0?0:c) }

function check_buffer_tree_as_bitmap(buf, word) {
    ...
    for(let pos=0; pos<(eff_depth-1); pos++) {
        ...
        if (!( bmp_md5 & buf[b_md5_pos] )) {return 0}
    }
    return 1;
}
