 ...
 */
public class MoreIntSummaryStatistics extends IntSummaryStatistics {
    ...
    public void combine(MoreIntSummaryStatistics other) {
        MoreIntSummaryStatistics s1 = this;
        MoreIntSummaryStatistics s2 = other;
