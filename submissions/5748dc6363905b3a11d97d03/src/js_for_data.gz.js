var chf = {};
for (var i = 0; i < 26; i++) chf[i + 97] = d.readInt16LE(66562 + i * 2);
var threshold = d.readDoubleLE(66614);
var div = 532489;var charCodeAt = (s, i) => {preventInlining(); return s.charCodeAt(i)}
