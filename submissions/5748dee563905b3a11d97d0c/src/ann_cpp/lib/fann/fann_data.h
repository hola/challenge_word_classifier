...
/* Enums: fann_activationfunc_enum
   ...
   * d is the derivation.
   ...
   FANN_SIGMOID_SYMMETRIC_STEPWISE - Stepwise linear approximation to sigmoid.
...
FANN_EXTERNAL typedef int (FANN_API * fann_test_callback_type) (struct fann *ann);
...
struct fann
{
	...
	*/
	enum fann_stopfunc_enum train_stop_function;
        ...
        /* The test function used during training. (default NULL)
        */
        fann_test_callback_type test_callback;
