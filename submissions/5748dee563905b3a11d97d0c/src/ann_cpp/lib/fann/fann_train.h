...
/* Variant to be used in conjunction with fann_create_train_noalloc()
 */
FANN_EXTERNAL void FANN_API fann_destroy_train_noalloc(struct fann_train_data *train_data);
...
/* Function: fann_set_test_callback
   
   Sets the test callback function for use during training.
 	
   See <fann_callback_type> for more information about the callback function.
 */
FANN_EXTERNAL void FANN_API fann_set_test_callback(struct fann *ann, fann_test_callback_type callback);
